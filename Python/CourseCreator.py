...
class CourseCreator:
    def __init__(self):
        ...
        self.exitBTN = Button(
            "X",
            20,
            Point(self.screen.getWidth() - 25, self.screen.getHeight() - 30),
            Point(self.screen.getWidth(), self.screen.getHeight()),
        )
        self.exitBTN.draw(self.screen)
        self.addBTN = Button(
            "+",
            20,
            Point(self.screen.getWidth() - 50, self.screen.getHeight() - 30),
            Point(self.screen.getWidth() - 25, self.screen.getHeight()),
        )
        self.addBTN.draw(self.screen)
        self.removeBTN = Button(
            "-",
            20,
            Point(self.screen.getWidth() - 75, self.screen.getHeight() - 30),
            Point(self.screen.getWidth() - 50, self.screen.getHeight()),
        )
